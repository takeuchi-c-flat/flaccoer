...
describe BalancesController, 'ログイン・会計年度選択後' do
  ...
  describe '#edit' do
    example 'Balancesを作り込む' do
      expect(BalanceService).to receive(:pre_create_balances).with(current_fiscal_year).once
      get :edit
    end
  end
